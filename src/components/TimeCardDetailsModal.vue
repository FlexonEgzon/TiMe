...
import type { TimeCardDetailsPayload } from '../types/TimeCardDetailsPayload';
...
const emit = defineEmits<{
  ...
  (e: 'save-modal', payload: TimeCardDetailsPayload): void;
}>();
      ...
      <div class="w- max-w-3xl rounded-xl bg-gray-50 shadow-2xl ring-1 ring-black/5">
        ...
        <div class="flex items-start gap-3 border-b border-gray-200 px-5 py-4">
          ...
          <div class="flex-1">
            <input
              v-model="draftTitle"
              class="mt-1 w-full truncate rounded-md bg-transparent px-2 py-1 text-xl font-extrabold text-gray-900 outline-none ring-0 focus:bg-white focus:ring-2 focus:ring-blue-500"
              placeholder="Title"
            />
          </div>
          ...
          <div class="flex items-start gap-3">
            ...
            <div class="flex-1">
              ...
              <textarea
                ...
                rows="6"
                class="mt-2 w-full resize-none rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-900 outline-none focus:ring-2 focus:ring-blue-500"
